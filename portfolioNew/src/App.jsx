    ...
    return (
        <>
            ...
            <main
                ...
                className="relative w-full bg-gradient-to-b from-gray-900 from-30% to-black  font-poppins text-neutral-100"
            >
                <img
                    id="parallax-back"
                    src={LineGrid}
                    className="hidden sm:block sm:absolute w-full h-full md:max-h-screen inset-0 z-0 opacity-75"
                />
                ...
                <section id="parallax-front" className="relative z-20">
                    <Routes>
                        ...
                        <Route
                            path="*"
                            element={<h1>Oops! 404 Not Found.</h1>}
                        />
                    </Routes>
                    <Header />
                    <CMDK />
                    <Navbar
                        links={navLinks}
                        className={
                            "fixed bottom-[3rem] md:bottom-[4rem] left-[50%] z-10 -translate-x-[50%]"
                        }
                        animation={{
