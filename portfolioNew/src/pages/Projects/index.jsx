...
function ProjectPage() {
  ...
  return (
    <div className="w-full flex flex-col min-h-screen gap-8 p-4 py-24 md:px-8 pb-32">
        ...
        <main>
        <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 w-full py-4 pb-12 container">
          {
